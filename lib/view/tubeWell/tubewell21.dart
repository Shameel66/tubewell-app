...
class TubeWell21 extends StatefulWidget {
  @override
  _TubeWell21State createState() => _TubeWell21State();
}

class _TubeWell21State extends State<TubeWell21> {
  ...
  void initState() {
    ...
    super.initState();
    _schedule = FirebaseDatabase(databaseURL: 'https://tubewell21-7099d-default-rtdb.asia-southeast1.firebasedatabase.app/').reference().child('Op');
    ...
    _dbref = FirebaseDatabase(databaseURL: 'https://tubewell21-7099d-default-rtdb.asia-southeast1.firebasedatabase.app/').reference().child('Op');
  ...
  final databaseref = FirebaseDatabase(databaseURL: "https://tubewell21-7099d-default-rtdb.asia-southeast1.firebasedatabase.app/").reference().child("Op");
  String _startTime1 = "";
  String _startTime2 = "";
