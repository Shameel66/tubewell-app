...
class TubeWell16 extends StatefulWidget {
  @override
  _TubeWell16State createState() => _TubeWell16State();
}

class _TubeWell16State extends State<TubeWell16> {
  ...
  void initState() {
    ...
    super.initState();
    _schedule = FirebaseDatabase(databaseURL: 'https://tubewell16-default-rtdb.asia-southeast1.firebasedatabase.app/').reference().child('Op');
    ...
    _dbref = FirebaseDatabase(databaseURL: 'https://tubewell16-default-rtdb.asia-southeast1.firebasedatabase.app/').reference().child('Op');
  ...
  final databaseref = FirebaseDatabase(databaseURL: "https://tubewell16-default-rtdb.asia-southeast1.firebasedatabase.app/").reference().child("Op");
  String _startTime1 = "";
  String _startTime2 = "";
