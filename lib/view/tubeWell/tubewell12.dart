...
class TubeWell12 extends StatefulWidget {
  @override
  _TubeWell12State createState() => _TubeWell12State();
}

class _TubeWell12State extends State<TubeWell12> {
  ...
  void initState() {
    ...
    super.initState();
    _schedule = FirebaseDatabase(databaseURL: 'https://demotocheck-d7f3c-default-rtdb.firebaseio.com/').reference().child('Op');
    ...
    _dbref = FirebaseDatabase(databaseURL: 'https://demotocheck-d7f3c-default-rtdb.firebaseio.com/').reference().child('Op');
  ...
  final databaseref = FirebaseDatabase(databaseURL: "https://demotocheck-d7f3c-default-rtdb.firebaseio.com/").reference().child("Op");
  String _startTime1 = "";
  String _startTime2 = "";
