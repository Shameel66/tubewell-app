...
class TubeWell3 extends StatefulWidget {
  @override
  _TubeWell3State createState() => _TubeWell3State();
}

class _TubeWell3State extends State<TubeWell3> {
  ...
  void initState() {
    ...
    super.initState();
    _schedule = FirebaseDatabase(databaseURL: 'https://tubewell3-322c1-default-rtdb.asia-southeast1.firebasedatabase.app/').reference().child('Op');
    ...
    _dbref = FirebaseDatabase(databaseURL: 'https://tubewell3-322c1-default-rtdb.asia-southeast1.firebasedatabase.app/').reference().child('Op');
  ...
  final databaseref = FirebaseDatabase(databaseURL: "https://tubewell3-322c1-default-rtdb.asia-southeast1.firebasedatabase.app/").reference().child("Op");
  String _startTime1 = "";
  String _startTime2 = "";
