...
class TubeWell13 extends StatefulWidget {
  @override
  _TubeWell13State createState() => _TubeWell13State();
}

class _TubeWell13State extends State<TubeWell13> {
  ...
  void initState() {
    ...
    super.initState();
    _schedule = FirebaseDatabase(databaseURL: 'https://tubewell13-default-rtdb.asia-southeast1.firebasedatabase.app/').reference().child('Op');
    ...
    _dbref = FirebaseDatabase(databaseURL: 'https://tubewell13-default-rtdb.asia-southeast1.firebasedatabase.app/').reference().child('Op');
  ...
  final databaseref = FirebaseDatabase(databaseURL: "https://tubewell13-default-rtdb.asia-southeast1.firebasedatabase.app/").reference().child("Op");
  String _startTime1 = "";
  String _startTime2 = "";
