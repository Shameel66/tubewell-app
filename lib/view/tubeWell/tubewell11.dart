...
class TubeWell11 extends StatefulWidget {
  @override
  _TubeWell11State createState() => _TubeWell11State();
}

class _TubeWell11State extends State<TubeWell11> {
  ...
  void initState() {
    ...
    super.initState();
    _schedule = FirebaseDatabase(databaseURL: 'https://tubewell11-5c37f-default-rtdb.asia-southeast1.firebasedatabase.app/').reference().child('Op');
    ...
    _dbref = FirebaseDatabase(databaseURL: 'https://tubewell11-5c37f-default-rtdb.asia-southeast1.firebasedatabase.app/').reference().child('Op');
  ...
  final databaseref = FirebaseDatabase(databaseURL: "https://tubewell11-5c37f-default-rtdb.asia-southeast1.firebasedatabase.app/").reference().child("Op");
  String _startTime1 = "";
  String _startTime2 = "";
